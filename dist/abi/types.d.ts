...
interface SurgeInterfaceMulticallInterface extends ethers.utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "multicall", values: [{
        target: string;
...
export declare class SurgeInterfaceMulticall extends BaseContract {
    ...
    interface: SurgeInterfaceMulticallInterface;
    functions: {
    ...
    callStatic: {
        ...
        multicall(calls: {
            ...
            gasLimit: BigNumberish;
            callData: BytesLike;
        }[], overrides?: CallOverrides): Promise<[BigNumber, ([boolean, BigNumber, string] & {
            success: boolean;
            gasUsed: BigNumber;
            returnData: string;
        })[]] & {
